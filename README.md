...
```javascript
isInteger = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/math-base-assert-is-integer@v0.2.6-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/math-base-assert-is-integer/actions/workflows/test.yml/badge.svg?branch=v0.2.6
[test-url]: https://github.com/stdlib-js/math-base-assert-is-integer/actions/workflows/test.yml?query=branch:v0.2.6
